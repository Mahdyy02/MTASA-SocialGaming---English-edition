...
function create_train(plr, cmd, args)
	...
	local engine_blip = createBlipAttachedTo(new_train, 34, 1, 200, 200, 200, 200, 0, 180)
	setElementData(engine_blip,"blip >> name","Vonat");
	...
	setElementData(ped,"ped >> type","Mozdonyvezető");
	setElementData(ped,"ped >> name","Joe A Alverez");
