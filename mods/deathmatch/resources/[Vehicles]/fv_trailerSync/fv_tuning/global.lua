...
menu = {
    [1] = {
        ...
        ["submenu"] = {
            {"Motor",
                {
                    {"Manufacturing",0,false, {{"engineAcceleration", 0}, {"maxVelocity", 0}}},
            ...
            {"Bill",{
                    {"Manufacturing",0,false,{{"engineAcceleration", 0}}},
            ...
            {"Chip",{
                    {"Manufacturing",0,false,{{"maxVelocity", 0}}},
            ...
            {"Brakes",{
                    {"Manufacturing",0,false,{{"brakeDeceleration", 0}, {"brakeBias", 0}}},
            ...
            {"Tires",{
                    {"Manufacturing",0,false,{{"tractionMultiplier", 0}, {"tractionLoss", 0}}},
    ...
    [3] = {
        ...
        ["submenu"] = {
            ...
            {"Lamp color",{"Coloring",25000},"headlight"},
            {"PaintJob",4,3000},
        }
    },
    [4] = {
...
function formatMoney(amount)
	...
	local left,num,right = string.match(tostring(amount),'^([^%d]*%d)(%d*)(.-)dt')
...
function getPerformanceName(value)
    ...
    return names[value] or "Manufacturing";
end