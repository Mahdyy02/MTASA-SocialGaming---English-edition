...
local wallThread = false
local signThread = false
local planeThread = false
...
addEventHandler( "onClientResourceStart", getResourceRootElement(), function()
    ...
    wallThread = coroutine.create(loadSAMPWalls)
    signThread = coroutine.create(loadSAMPSigns)
    planeThread = coroutine.create(loadSAMPPlanes)

    coroutine.resume(wallThread)
    coroutine.resume(signThread)
    coroutine.resume(planeThread)
end)
