...
--exports.fv_admin:addAdminCommand("cd", 8, "Debugscript ürítése")
...
--exports.fv_admin:addAdminCommand("debugon", 8, "Debugscript bekapcsolása")
addCommandHandler("debugon",
	function ()
		if getElementData(localPlayer, "admin >> level") >= 10 then
			if not debugscriptActive then
				Roboto = dxCreateFont("Roboto-Regular.ttf", 14, false, "antialiased")
...
--exports.fv_admin:addAdminCommand("debugoff", 8, "Debugscript kikapcsolása")
